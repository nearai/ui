...
function breakpointCssValue(value: string | undefined, propKey: string, convertValue: boolean) {
  if (convertValue) {
...
export function breakpointPropToCss<T>(
  ...
  variables[`--${name}`] = breakpointCssValue(props[propKey] as string | undefined, propKey, convertValue);
