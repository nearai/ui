...
import { InputAssistiveText } from '../Input';
...
export const Slider = forwardRef<HTMLInputElement, Props>(
  ({ assistive, error, success, onChange, value, label, step = 1, ...props }, ref) => {
    ...
    return (
      <label className={s.slider}>
        ...
        <InputAssistiveText variant={variant} message={error ?? success ?? assistive} />
      </label>
    );
  },
);
